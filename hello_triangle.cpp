...
void hello_triangle::recordCommandBuffer(VkCommandBuffer cmdBuffer, uint32_t imageIndex) {
...
void hello_triangle::createSurface() {
...
void hello_triangle::createSwapChain() {
...
void hello_triangle::createCommandPool() {
...
void hello_triangle::createCommandBuffer() {
...
void hello_triangle::createSyncObjects() {
